...
public class MethodCall2 {
    public static void main(String[] args) throws Exception{
        ...
        //spring에서 사용하는 클래스 (model 의 구현체클래스)
        //3. MODEL 생성
        ...
        String viewName = (String)main.invoke(obj, new Object[] { 2021, 10, 1, model }); //갯수가 달라질수있기 때문에 배열로 받는다.(Reflection API를 이용한 호출)
    ...
    static void render(Model model, String viewName) throws IOException {
        ...
        while(sc.hasNextLine()) //한줄씩 읽어서 치환
